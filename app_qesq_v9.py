...
def Load_Images_from_path(introduced_path,n_images):
        ...
        if st.session_state['init_data']['finished_game']:
            ...
            if not st.session_state['init_data']['start_game']:
                ...
                if Selected_Images_Source=='Use images from specific path':
                    ## specific path - text
                    st.markdown("<h style='text-align:left; float:left; color:black; margin:0px;'>To use images from specific path, press 'Use Path'.</h3>",
                                unsafe_allow_html=True)
		    ...
		    st.markdown("<h3 style='text-align:center; float:left; color:blue; margin-left:0px; margin-right:25px; margin-top:0px; margin-bottom:0px;'>Current path: </h3><h3 style='text-align:left; float:center; color:green; margin:0px;'>"+User_Input_Path+"</h3>", unsafe_allow_html=True)
